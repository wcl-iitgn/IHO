            ...
            <div className='dasboard_page_container'>
                ...
                <div className='main_dashboard'>
                    ...
                    <div className='map_heading_mobile'>
                        <h1>
                            {(selectedMap.section === "Forecasted_meteorological_conditions" || selectedMap.section === "Forecasted_hydrological_conditions") ? "Forecast: " : ""}
                            {selectedMap.label}
                        </h1>
                    </div>
                    ...
                    <div className='right_panel'>
                        ...
                        >
                            ...
                            <div className='date_container'>
                                Based on: {<DateFunction days="observed_end" />}
